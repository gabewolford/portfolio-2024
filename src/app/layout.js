...
export const metadata = {
  title: "Gabe Wolford",
  description:
    "Software developer based in Portland, Oregon. Sweating the little details, putting the user first, and geeking out on good design.",
  keywords:
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body
        className={`flex flex-col min-h-screen w-full relative ${inter.className}`}
      >
        <Globe />
        <TheHeader />
        {children}
